...
- The parsing of heredocs has been improved. The parser should now
  follow the way that Puppet handles heredocs more closely.
  New node types for heredocs have been introduced so all clients will
  have to be updated to use this parser.
